    ...
    try:
        ...
        if not law_firm:
            ...
            return False
                ...
                # Note: VisaType queries removed - no longer needed with Petition model
        ...
        lei_h1b = VisaApplication(
            ...
            priority=PetitionPriority.CRITICAL,
        ...
        david_h1b_case = CaseGroup(
            ...
            pathway_type=PathwayType.H1B_TRANSFER,
